<?php
    ...
    $show_author    = apply_filters( 'sarmys_meta_page_author',     tempo_options::get( 'page-author' ) );
    $show_time      = apply_filters( 'sarmys_meta_page_time',       tempo_options::get( 'page-time' ) );
    $show_comments  = apply_filters( 'sarmys_meta_page_comments',   tempo_options::get( 'page-comments' ) );
    $show_views     = apply_filters( 'sarmys_meta_page_views',      tempo_options::get( 'page-views' ) );
