		...
		<div id="fm-paypal-properties">
			...
			<div class="fm-properties">
				...
				<div>
					...
					<img id="el_choices_add" src="<?php echo WD_FM_URL . '/images/add.png?ver='. get_option("wd_form_maker_version").''; ?>" style="vertical-align:middle; cursor: pointer;" title="add" onclick="add_choise_option()" />
				</div>
		...
		function save_options() {
			...
			if ($property_id == '-1') {
				...
				var li_edit_img = document.createElement('img');
					li_edit_img.setAttribute("src", "<?php echo WD_FM_URL . '/images/edit.png?ver='. get_option("wd_form_maker_version").''; ?>");
				...
				var li_x = document.createElement('img');
					li_x.setAttribute("src", "<?php echo WD_FM_URL . '/images/delete.png?ver='. get_option("wd_form_maker_version").''; ?>");
		...
		function type_add_options(w_choices) {
			...
			for (j = 0; j < n; j++) {
				...
				var el_choices_remove = document.createElement('img');
					...
					el_choices_remove.setAttribute("src", "<?php echo WD_FM_URL . '/images/delete.png?ver='. get_option("wd_form_maker_version").''; ?>");
